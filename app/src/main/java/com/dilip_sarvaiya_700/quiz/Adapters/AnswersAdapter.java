...
public class AnswersAdapter extends RecyclerView.Adapter<AnswersAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        private void setOptionColor(int selected, int color) {
           ...
           if(selected==1)
           {
               optionA.setTextColor(itemView.getContext().getResources().getColor(R.color.green));
           }
           else
           {
            ...
            if(selected==2)
            {
                optionB.setTextColor(itemView.getContext().getResources().getColor(R.color.green));
            }
            else
            {
            ...
            if(selected==3)
            {
                optionC.setTextColor(itemView.getContext().getResources().getColor(R.color.green));
            }
            else
            {
            ...
            if(selected==4)
            {
                optionD.setTextColor(itemView.getContext().getResources().getColor(R.color.green));
            }
            else
            {
