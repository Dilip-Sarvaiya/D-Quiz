...
import com.dilip_sarvaiya_700.quiz.BookmarksActivity;
...
public class BookmarksAdapter extends RecyclerView.Adapter<BookmarksAdapter.ViewHolder> {
    ...
    @NotNull
    @Override
    public BookmarksAdapter.ViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull @NotNull BookmarksAdapter.ViewHolder holder, int position) {
